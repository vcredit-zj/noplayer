...
import com.vcredit.zj.base.presenter.LazyFragmentPresenter;
 ...
 */
public abstract class DataBindLazyFragment<T extends IDelegate, D extends ViewDataBinding> extends
        LazyFragmentPresenter<T> {
